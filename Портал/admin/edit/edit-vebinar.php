...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if (empty($errors)) {
            ...
            $stmt = $pdo->prepare("UPDATE activities SET Title = ?, ArrangedAt = ?, Short = ?, Info = ?, Theme = ? WHERE Id = ?");
            $stmt->execute([
                $title,
                $date ?: null,
                $short_description,
            ...
            echo '<script>window.location.href = "../vebinar-admin.php";</script>';
            exit;
        }
    }
} else {
    ...
    <div class="back" style="border-top: solid #d1cdcd;">
        <div class="posts col-9">
            ...
            <div>
                ...
                <form action="edit-vebinar.php?id=<?= $id ?>" method="post" enctype="multipart/form-data">
