<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
        ...
        deletePostById($deleteId, "videos"); 
    ...
    $years = getTime("videos");
    $Themes = getThemes("videos");
    
    $videos = getWithFilter("videos", $selectedTheme, $selectedYear, $selectedMonth);
?>
...
<body>
    ...
    <table style="height: 110px; width: 1690px;">
        <tr>
            <td>
            <div class="filters">
                <form action="video-admin.php" method="GET">
                        <div class="themes">
            ...
            <td>
                <div class="plate">
                    <h1 style="text-align: center; margin-left: 200px;"> Видео <a href ="create-edit.php">
