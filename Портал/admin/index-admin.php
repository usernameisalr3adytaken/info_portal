        ...
        <tr>
            <td >
                <div class="links">
                    ...
                    <!-- Кнопка выхода из админ-сессии -->
                    <div class="logout-section" style="margin-top: 60px; text-align: center;">
                        <form action="../construct/logout.php" method="post" style="margin: 0;">
