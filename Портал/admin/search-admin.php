                            ...
                            <?php foreach ($posts as $post): ?>
                                <div class="article">
                                    ...
                                    <table class="inside_table" style="width: 100%; border-collapse: collapse; transition: all 0.3s ease;">
                                        ...
                                        <td style="width: 7%;">
                                            <a href ="create-edit.php"><img src="../img/edit.png" style="width: 36px; height: 36px; margin-top: 240px; margin-left: 10px;"></a>
                                            <a><img src="../img/trash.png" style="width: 36px; height: 36px; margin-top: 20px; margin-left: 10px;"></a>
                                        </td>
                                        </tr>
                                    </table>
                                    </a>
                                    ...
                                    <table class="inside_table" style="width: 100%; border-collapse: collapse; transition: all 0.3s ease;">
                                        <tr style="transition: all 0.3s ease;">
                                            ...
                                            <td style="width: 20%; vertical-align: middle; transition: all 0.3s ease;">
                                                ...
                                                <a href ="create-edit.php"><img src="../img/edit.png" style="width: 36px; height: 36px; margin-top: 50px; margin-left: 85px;"></a>
                                                <a><img src="../img/trash.png" style="width: 36px; height: 36px; margin-top: 20px; margin-left: 10px;"></a>
                                            </td>
                                        </tr>
                                    </table>
