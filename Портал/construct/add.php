...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_post'])) {
    ...
    if (!$title) {
        ...
        switch ($recordType) {
            case 'Статья':
                $imagePath = uploadImage($_FILES['file'], "Posts");
                if (!$imagePath){
            ...
            case 'Видео':
                $imagePath = uploadImage($_FILES['file'], "Videos");
                if (!$fileVid) {
            ...
            case 'Мероприятие':
                $imagePath = uploadImage($_FILES['file'], "Events");
                if (!$dateConducted) {
            ...
            case 'Вебинар':
                $imagePath = uploadImage($_FILES['file'], "Activities");
                if (!$dateConducted) {
